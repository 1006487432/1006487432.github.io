...
![ruler.png (885×459)](https://raw.githubusercontent.com/1006487432/1006487432.github.io/refs/heads/master/static/images/exp4/ruler.png)

1.代码实现了用户登录和注册功能，使用了SM3哈希算法和盐值来存储和验证用户密码，并对不同密级人员进行分类  0.7

2.访问控制信息未作完整性保护   0.4

3.重要信息资源安全标记完整性，对上传的公文使用SM3进行hash运算   0.4

4.重要数据传输机密性，未使用https进行网站搭建 0.4

5.重要数据存储机密性，使用sm4进行加密 0.7

6.重要数据传输完整性，未使用https保障完整性 0.4

7.重要数据存储完整性，使用sm2签名保障 0.7
