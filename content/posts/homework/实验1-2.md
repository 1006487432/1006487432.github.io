...
~~~ shell
 exp1-rust  .\target\debug\exp1-rust.exe -e -in plain.txt -pub youpub.pem -my mykey.pem -key key.bin -iv iv.bin
Success!
 exp1-rust  .\target\debug\exp1-rust.exe -d -in alice -my youkey.pem -pub mypub.pem -iv iv.bin
 exp1-rust  cat .\decrypt.txt
20221415cjs
