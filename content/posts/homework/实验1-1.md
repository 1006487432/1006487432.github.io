...
-----END PRIVATE KEY-----
[root@localhost exp1]# openssl asn1parse -inform PEM -in sm2private_key.pem
...
~~~shell
[root@localhost exp1]# vim plain.txt
[root@localhost exp1]# openssl rand -out k.bin 16
[root@localhost exp1]# openssl sm4-cbc -kfile k.bin -iv "da80e405a4998c351b0717093cbe86ab" -in plain.txt -out 1415_c
[root@localhost exp1]# openssl pkeyutl -encrypt -pubin -inkey 1423/openssl_1423_pub.pem -in k.bin -out kc.bin
[root@localhost exp1]# openssl pkeyutl -sign -inkey sm2private_key.pem -in 1415_c -out 1415_c.sig
~~~

Bob-20221423的操作结果:

~~~ shell
$ openssl pkeyutl -verify -inkey openssl_1415_pub.pem -pubin -in 1415_c -sigfile 1415_c.sig
Signature Verified Successfully
$ openssl pkeyutl -decrypt -inkey openssl_1423_pri.pem -in kc.bin -out k.bin
$ ls k.bin
k.bin
$ openssl sm4-cbc -d -kfile k.bin -iv "da80e405a4
998c351b0717093cbe86ab" -in 1415_c -out plain.txt
...
~~~ shell
[root@localhost gm]# ls
1415sm2.der  1423_c.sig  cjssm4.cbc   cjssm4.cbc3  gmssl_1423_pub.pem  key.bin  sm2.pem     sm2.sig
1423_c.cbc3  cjs.sm3     cjssm4.cbc2  cjs.txt      iv.bin              sm2.der  sm2pub.pem
三个文件：1415sm2.der  1423_c.sig 1423_c.cbc3
~~~

Alic执行的命令：

~~~ shell
[root@localhost gm]# gmssl sm2verify -pubkey gmssl_1423_pub.pem -sig 1423_c.sig -in 1423_c.cbc3 
verify : success
[root@localhost gm]# gmssl sm2decrypt -key sm2.pem -pass 1415 -in 1415sm2.der  -out gm_k.bin
[root@localhost gm]# gmssl sm4_cbc -decrypt -key $(xxd -p -c 32 gm_k.bin) -iv $(xxd -p -c 32 iv.bin) -in 1423_c.cbc3 -out
 plain.txt
[root@localhost gm]# cat plain.txt 
20221423bx
~~~
